...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_3.setText(_translate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">Welcome to the Sugarchain GUI miner. </span><span style=\" font-weight:600; font-style:italic; color:#ff0000;\">Warning: This miner is only for YesPowerSugar, not for the use of other Yespower coins.</span></p><p><span style=\" font-weight:600; color:#000000;\">To start mining, choose Solo or Pool. If Solo, use http://127.0.0.1. If Pool, use the pool provided url.</span></p><p><span style=\" font-weight:600; text-decoration: underline; color:#000000;\">Pool:</span><span style=\" font-weight:600; color:#000000;\"> Enter your Sugarchain address and click \'Start\'.</span></p><p><span style=\" font-weight:600; text-decoration: underline; color:#000000;\">Solo:</span><span style=\" font-weight:600; color:#000000;\"> Enter your Sugarchain address, followed by the \'rpcuser\' and \'rpcpassword\' you set in you wallet configuration. Then click \'Start\'</span></p><p><br/></p></body></html>"))
        self.label.setText(_translate("Form", "Solo/Pool URL:"))
        self.label_4.setText(_translate("Form", "Sugarchain Address:"))
        self.label_9.setText(_translate("Form", "<html><head/><body><p>rpcuser: (only for solo mining)</p></body></html>"))
        self.label_10.setText(_translate("Form", "<html><head/><body><p>rpcuser: (only for solo mining)</p></body></html>"))
        self.comboBox.setItemText(0, _translate("Form", "Solo"))
        self.comboBox.setItemText(1, _translate("Form", "Pool"))
        ...
        self.label_11.setText(_translate("Form", "CPU Cores:"))
